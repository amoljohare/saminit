pipeline {
  ...
  environment {
    ...
    SAM_TEMPLATE = 'sam-app-20/template.yaml'
    MAIN_BRANCH = 'main'
    TESTING_STACK_NAME = 'sam-app-20-dev'
    TESTING_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::721577853869:role/aws-sam-cli-managed-dev-pipe-PipelineExecutionRole-FLBNZTOKUBD5'
    TESTING_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::721577853869:role/aws-sam-cli-managed-dev-p-CloudFormationExecutionR-1G7XYTD7U39JV'
    TESTING_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-dev-pipeline-artifactsbucket-1eqpbvudtoz6e'
    // If there are functions with "Image" PackageType in your template,
    // uncomment the line below and add "--image-repository ${TESTING_IMAGE_REPOSITORY}" to
    // testing "sam package" and "sam deploy" commands.
    // TESTING_IMAGE_REPOSITORY = '0123456789.dkr.ecr.region.amazonaws.com/repository-name'
    TESTING_REGION = 'ap-south-1'
    PROD_STACK_NAME = 'sam-app-20-prod'
    PROD_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::721577853869:role/aws-sam-cli-managed-prod-pip-PipelineExecutionRole-6F9YBUN9EF1E'
    PROD_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::721577853869:role/aws-sam-cli-managed-prod-CloudFormationExecutionR-1SM1Z9Z3E0J5H'
    PROD_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-prod-pipeline-artifactsbucket-1nl2j7sgqz0rn'
    // If there are functions with "Image" PackageType in your template,
